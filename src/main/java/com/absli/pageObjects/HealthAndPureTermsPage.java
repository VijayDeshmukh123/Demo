	 ...
	 public WebDriver driver;
	    ...
	    public void selectPlanJourneyRecommendPlansWeb(String val) {
	        ...
	        if (recomendPlan.isDisplayed()) {
	        	recomendPlan.click();
	        	//ExtentFactory.getInstance().getExtent().log(Status.INFO, "Click on "+val);
	        }else {
	        	//ExtentFactory.getInstance().getExtent().log(Status.FAIL, val+" is Not Display ");
	        }
	    }
...
//			WebElement text =  getDriver().findElement(By.xpath("//div[contains(text(),'"+val+"')]"));
//			TestUtil.scrollToElement(driver, selectplanWeb);
